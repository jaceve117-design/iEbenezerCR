# Ebenezer Tibás — iglesia madre

San José, Tibás. Es la sede central; el resto de congregaciones del país saldrán de
esta misma base (ver el README de la raíz del repositorio).
...
```bash
npx wrangler pages deploy tibas/public --project-name iebenezer-tibas
```
